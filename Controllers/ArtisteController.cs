...
namespace DeviantMusicCore.Controllers
{
    public class ArtisteController : Controller
    {
        ...
        public ArtisteController(DeviantContext _db, UserManager<ApplicationUser> _userManager)
        {
            db = _db;
        ...
        public async Task<IActionResult> Index(int? pageNumber)
        {
            ...
            var users = userManager.Users.Where(user => user.IsArtiste.Equals(true))
        ...
        [HttpGet]
        public async Task<IActionResult> Artiste(string id)
        {
            if(id==null)
            {
                return NotFound();
            }
            var user = await userManager.Users.Include(u => u.Products)
                                                .Include(u => u.Beats)
